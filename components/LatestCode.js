    ...
    <section className="bg-[#F1F1F1] -mt-20 dark:bg-gray-900 text-gray-500 pb-40">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:pt-40 mx-10">
          <h1 className="text-6xl lg:text-9xl max-w-lg lg:py-3 lg:mb-16 font-bold text-gray-700 text-outline-100 py-20 md:my-0  dark:text-gray-200 text-center lg:text-left">
            Latest Code
          </h1>
...
const GithubRepoCard = ({ getLatestRepos }) => {
  return (
    <div className="github-repo">
      ...
      <p className="text-base font-normal my-4 text-gray-700 dark:text-white">
        {getLatestRepos.description}
      </p>
      <a
        target='_blank'
        href={getLatestRepos.clone_url}
        className="font-semibold font-mono text-gray-700 group flex flex-row space-x-2 w-full items-center dark:text-white"
      >
        <p>View Repository </p>
