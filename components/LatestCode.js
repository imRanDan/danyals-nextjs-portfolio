    ...
    <section className="bg-[#F1F1F1] -mt-20 dark:bg-gray-900 text-gray-500 pb-40">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center md:pt-40 mx-10">
          <h1 className="text-6xl lg:text-9xl max-w-lg lg:py-3 lg:mb-16 font-bold text-gray-700 text-outline-100 py-20 md:my-0  dark:text-gray-600 text-center lg:text-left">
            Latest Code
          </h1>
