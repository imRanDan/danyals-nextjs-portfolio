  ...
  return (
    <footer className="bg-[#F1F1F1] dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-10 md:py-20">
        ...
        <div className="flex flex-col space-y-8 md:space-y-0 md:flex-row justify-between items-center mt-8 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex space-x-6">
            <a
              href="https://github.com/imRanDan"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#a4cfe4] transition-colors"
              aria-label="GitHub"
            >
            ...
            <a
              href="https://linkedin.com/in/danyalimran"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#a4cfe4] transition-colors"
              aria-label="LinkedIn"
